...
function SidebarGroup({
  ...
  return (
    <div
      ...
      data-sidebar="group"
      className={cn("relative flex w-full min-w-0 flex-col group-data-[collapsible=icon]:p-0 p-2", className)}
      {...props} />
  );
}
...
function SidebarMenu({
  ...
  return (
    <ul
      ...
      data-sidebar="menu"
      className={cn("flex  group-data-[collapsible=icon]:items-center w-full min-w-0 flex-col gap-1", className)}
      {...props} />
  );
}
